...
```html
  <head>
    ...
    <!-- AngularJS Material CSS now available via Google CDN; version 1.1.1 used here -->
  ...
  <body>
    ...
    <!-- AngularJS Material Javascript now available via Google CDN; version 1.1.1 used here -->
