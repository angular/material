(function () {
  ...
  exports.task = function () {
    exec([
      'rm -f ../docs/app/contributors.json',
      'githubcontrib --owner=angular --repository=material --cols=6 --format=json --showlogin=true --sortBy=login --sha=master > ./docs/app/contributors.json'
      ]);
  };
