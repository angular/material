  ...
  /**
    ...
    *
    * **Notice:** The most font-icons are not supporting ligatures. (for example `fontawesome`)<br/>
    *  That means, you are not able to use the icon's ligature name - Like so:
    *
    *  <hljs lang="html">
    *    <md-icon md-font-set="fa">fa-bell</md-icon>
    *  </hljs>
    *
    * You should rather use the given unicode, instead of the ligature name.
    *
   ...
   *
   * @description
   * When using a font set for `<md-icon>`, then you have to specify the correct font classname in the `md-font-set`
   * attribute.
   *
   * Sometimes those fontset classNames are really uncomfortable / long, that's why you can create
   * an alias for a fontset.
   *
