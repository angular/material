...
function GridListDirective($interpolate, $mdConstant, $mdGridLayout, $mdMedia, $mdUtil) {
  ...
  function postLink(scope, element, attrs, ctrl) {
    ...
    function getGutter() {
      return applyDefaultUnit($mdMedia.getResponsiveAttribute(attrs, 'md-gutter') || 1, 'px');
    }
 ...
 * cells vertically or horizontally. They use `md-grid-tile-{footer,header}` to
 ...
 *    exceed the number of columns in the grid.
 * @param {number=} md-rowspan The number of rows to span (default 1)
 *
 * @usage
 * <hljs lang="html">
