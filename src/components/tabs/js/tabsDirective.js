 ...
 * @param {boolean=} md-button-offset When present, add an offset to the tabs to align the first tab with the toolbar title (when using a icon button before the title)
 *
 * @usage
 * <hljs lang="html">
