(function() {
  ...
  /** Class applied to the cells between the start and end dates for the date-range-picker context. */
  var CELLS_WITHIN_RANGE_CLASS = 'md-calendar-date-range';
    ...
    if (opt_date) {
      ...
      if (!calendarCtrl.isDateRange) {
        ...
        if (this.dateUtil.isValidDate(calendarCtrl.selectedStartDate) &&
          ...
          cell.classList.add(SELECTED_START_DATE_CLASS);
          cell.setAttribute('aria-selected', 'true');
        }

        if (this.dateUtil.isValidDate(calendarCtrl.selectedEndDate) &&
            this.dateUtil.isSameDay(opt_date, calendarCtrl.selectedEndDate)) {
          cell.classList.add(SELECTED_END_DATE_CLASS);
          cell.setAttribute('aria-selected', 'true');
        }

        if (opt_date >= this.calendarCtrl.selectedStartDate && opt_date <= this.calendarCtrl.selectedEndDate) {
          cell.classList.add(CELLS_WITHIN_RANGE_CLASS);
        }
      }
