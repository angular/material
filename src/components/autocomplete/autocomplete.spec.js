describe('<md-autocomplete>', function() {
  ...
  describe('basic functionality', function () {
    it('should update selected item and search text', inject(function($timeout, $mdConstant, $rootElement) {
      ...
      ctrl.keydown({ keyCode: $mdConstant.KEY_CODE.DOWN_ARROW, preventDefault: angular.noop, stopPropagation: angular.noop });
      ctrl.keydown({ keyCode: $mdConstant.KEY_CODE.ENTER, preventDefault: angular.noop, stopPropagation: angular.noop });
      scope.$apply();
      $timeout.flush();
