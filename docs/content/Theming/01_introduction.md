...
Material Design is a visual language with innovative user experiences (UX) and user interface (UI) elements. Themes convey meaning through color, tones, and contrasts, similar to how Layouts convey meaning through keylines and alignments.
...
Currently, theming only effects colors and font family. Additional customizations such as font styles, padding, borders, and spacing are planned for future releases.
