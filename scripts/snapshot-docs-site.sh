...
function run {
  ...
  sed -i "s,https://rawgit.com/angular/bower-material/master/angular-material,https://cdn.rawgit.com/angular/bower-material/v$VERSION/angular-material,g" dist/docs/docs.js
