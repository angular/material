...
exports.humanizeCamelCase = function(str) {
	/**
	 * This has been customized to capitalize TST and FAB
	 */

	var prefixes = ['tst', 'fab'];

	if(prefixes.indexOf(str.substring(0, 3)) > -1) {
		return str.charAt(0).toUpperCase() + str.charAt(1).toUpperCase() + str.charAt(2).toUpperCase() + str.substring(3).replace(/[A-Z]/g, function($1) {
